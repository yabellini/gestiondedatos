...
![Diagrama Entidad Relación](img/Grupo1-Ejercicio2-Clase4.png){fig-alt="Diagrama Entidad Relación con dos tablas: Aeropuertos y Medidas"}

#### Grupo 2

Seleccionar una relación para aplicar integridad referencial. Explicar que pasa en cada tabla si se eliminan, agregan o modifican registros.

![Diagrama de Entidad Relación](img/Grupo2-Ejercicio2-Clase4.png){fig-alt="Diagrama de Entidad Relación con tablas de vehículos, clases, transmiciones, motores, tracciones, frabicantes, combustibles y modelos."}

#### Grupo 3

Seleccionar una relación para aplicar integridad referencial. Explicar que pasa en cada tabla si se eliminan, agregan o modifican registros.

![Diagrama de Entidad Relación](img/Grupo3-Ejercicio2-Clase4.png){fig-alt="Diagrama de Entidad Relación con las tablas Isla y Pingüinos"}
