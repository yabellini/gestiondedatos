...
6.  Listar cada playlist con el total de pistas que tiene cada una.
...
15. General una tabla que combine el nombre completo del cliente y del empleado que lo atendió.

16. Contar la cantidad de pistas por género.

17. Modificar la consulta anterior para mostrar el nombre del género en la lista en vez del id. 
...
Resolver los siguientes ejercicios en R. La figura presenta el Diagrama Entidad Relación y este es significado de los nombres de las tablas en castellano.
